    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expert_profile_set', to='accounts.abstractprofile')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('abstractprofile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='accounts.abstractprofile')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_profile_set', to='accounts.abstractprofile')),
            ],
            bases=('accounts.abstractprofile',),
        ),
    ]
